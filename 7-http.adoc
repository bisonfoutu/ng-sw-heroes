...
`HttpClient.get` retourne le _body_ de la réponse comme un objet JSON non-typé par défaut. En appliquant un spécifieur de type optionnel, `<Hero[]>`, vous obtenez un résultat sous forme d'objet typé.
